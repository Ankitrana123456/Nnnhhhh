...
async def start(bot, m: Message):
    ...
    if m.chat.id in AUTH_USERS:
        keyboard = InlineKeyboardMarkup([
            ...
            [InlineKeyboardButton(text="📞 Contact", url=f"tg://openmessage?user_id={OWNER}"), InlineKeyboardButton(text="𝐒𝙷𝙰𝚁𝙼𝙰 Ꭻɪ", url="https://t.me/OWNER_0044")],
        ])
        ...
        await start_message.edit_text(
           f" 🎉 Welcome {m.from_user.first_name} to txt to video uploader 💗 Bot! 🎉\n\n"
...
async def back_to_main_menu(client, callback_query):
    ...
    keyboard = InlineKeyboardMarkup([
            [InlineKeyboardButton("💎 Features", callback_data="feat_command"), InlineKeyboardButton("🖱️Commands", callback_data="cmd_command")],
            [InlineKeyboardButton("💳 Plans", callback_data="upgrade_command")],
            [InlineKeyboardButton(text="📞 Contact", url=f"tg://openmessage?user_id={OWNER}"), InlineKeyboardButton(text="𝐒𝙷𝙰𝚁𝙼𝙰", url="https://t.me/OWNER_0044")],
        ])
    ...
    try:
        for i in range(arg-1, len(links)):
            ...
            if "edge.api.brightcove.com" in url:
                ...
                url = f"https://anonymouspwplayerr-f996115ea61a.herokuapp.com/pw?url={url}&token={pwtoke}"
